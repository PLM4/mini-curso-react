...
function TaskPage() {
  ...
  return (
    <div className="bg-slate-500 min-h-screen min-w-screen flex items-center justify-center">
      <div className="w-screen h-screen bg-slate-500 flex justify-center p-6 mx-auto">
